        ...
        try {
          if (typeof event.data === "string") {
            ...
            if (Array.isArray(parsedData)) {
              ...
              console.error(
                "Parsed data is neither array nor expected object:",
                parsedData,
              );
            }
          } else {
      ...
      interval = setInterval(() => {
        try {
          const newVitals = {
            heartRate: Math.max(
              60,
              Math.min(100, vitalSigns.heartRate + (Math.random() - 0.5) * 6),
            ),
            bloodPressure: {
              systolic: Math.max(
                90,
                Math.min(
                  140,
                  vitalSigns.bloodPressure.systolic + (Math.random() - 0.5) * 4,
                ),
              ),
              diastolic: Math.max(
                60,
            ...
            oxygenSaturation: Math.max(
              ...
              Math.min(
                100,
                vitalSigns.oxygenSaturation + (Math.random() - 0.5) * 1,
              ),
            ),
            respiratoryRate: Math.max(
              ...
              Math.min(
                20,
                vitalSigns.respiratoryRate + (Math.random() - 0.5) * 2,
              ),
            ),
          };
          ...
          if (newVitals.heartRate > 90 || newVitals.heartRate < 65) {
            ...
            setAlerts((prevAlerts) => {
              const newAlert = {
                ...
                timestamp: new Date(),
                severity:
                  newVitals.heartRate > 95 || newVitals.heartRate < 60
                    ? "high"
                    : "medium",
              };
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Live vital signs with AI-powered alerts
            </p>
          </div>
        </div>
        <div className="flex items-center space-x-3">
        ...
        <Card className="glass-morphism border border-border/20 hover-lift">
          <CardContent className="p-6">
            ...
            <div className="space-y-2">
              <div className="flex items-baseline space-x-1">
                <span className="text-3xl font-bold text-foreground">
                  {Math.round(vitalSigns.bloodPressure.systolic)}/
                  {Math.round(vitalSigns.bloodPressure.diastolic)}
                </span>
