              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {formatPercentage(data.orders.conversionRate)}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {formatPercentage(data.customers.retention)}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">
                  ...
                  <span className="font-medium text-red-600">
                    {formatPercentage(data.performance.cartAbandonment)}
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {formatNumber(data.performance.pageViews)}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {formatPercentage(data.performance.bounceRate)}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600">
                  ...
                  <span className="font-medium">
                    {data.performance.avgSessionDuration} min
                  </span>
                </div>
              </CardContent>
            </Card>
