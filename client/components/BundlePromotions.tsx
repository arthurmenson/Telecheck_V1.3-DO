        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {LIMITED_TIME_OFFERS.map((offer) => {
            const stockPercentage =
              ((offer.limitedQuantity - offer.soldCount) /
            ...
            return (
              <Card
                key={offer.id}
                className="border-2 border-red-200 dark:border-red-800 relative overflow-hidden"
              >
                ...
                <CardHeader className="pb-3">
                  <div className="space-y-2">
                    <Badge className={getUrgencyColor(offer.urgencyLevel)}>
                      ...
                      {offer.urgencyLevel === "medium" && (
                        <Clock className="w-3 h-3 mr-1" />
                      )}
                      {offer.urgencyLevel === "low" && (
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-green-600">
                        Save{" "}
                        {formatPrice(offer.originalPrice - offer.salePrice)}
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {offer.limitedQuantity - offer.soldCount} of{" "}
                        {offer.limitedQuantity} left
                      </span>
                    </div>
                    <Progress
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400">
                      {offer.popularityScore}% of customers recommend this
                      bundle
                    </span>
                  </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {SAMPLE_BUNDLES.map((bundle) => (
            <Card
              key={bundle.id}
              className="border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all duration-300 group"
            >
              <CardHeader>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-purple-700 dark:text-purple-300 mb-4">
                  Earn points on every purchase, get exclusive access to new
                  bundles, and enjoy member-only discounts.
                </p>
