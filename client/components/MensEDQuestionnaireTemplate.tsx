...
const MENS_ED_ROCO_QUESTIONNAIRE = {
  ...
  description:
    "A discrete, comprehensive medical evaluation designed by healthcare professionals",
  empathicIntro:
    "Erectile dysfunction affects over 30 million men in the US. You're taking an important step toward better health and intimacy. This assessment is completely confidential and designed to help our medical team provide you with the most appropriate treatment options.",
  ...
  questions: [
    {
      ...
      empathicMessage:
        "Age helps us determine the most appropriate treatment approach and dosing recommendations.",
    ...
    },
    {
      ...
      empathicMessage:
        "ED can develop gradually or suddenly. Both are common and treatable.",
      options: [
        "Less than 3 months",
        "3-6 months",
        "6-12 months",
    ...
    },
    {
      ...
      subtitle:
        "This follows the International Index of Erectile Function (IIEF-5) scale",
      empathicMessage:
        "These questions are based on validated medical questionnaires used by doctors worldwide.",
      options: [
    ...
    },
    {
      ...
      type: "multiple_choice",
      title:
        "When you had erections, how often were they firm enough for penetration?",
      subtitle: "Firmness is an important factor in treatment selection",
      empathicMessage:
        "Different medications work better for different types of erectile challenges.",
      options: [
        "Almost always or always",
        "Most times (more than half the time)",
        "Sometimes (about half the time)",
    ...
    },
    {
      ...
      empathicMessage:
        "These details help ensure you receive the most effective treatment.",
      options: [
        "Not difficult",
        "Slightly difficult",
    ...
    },
    {
      ...
      empathicMessage:
        "Some men can achieve erections but have trouble maintaining them - this is completely normal.",
      options: [
        "Almost always or always",
        "Most times (more than half the time)",
        "Sometimes (about half the time)",
    ...
    },
    {
      ...
      empathicMessage:
        "Low confidence is common with ED, but effective treatment often restores both function and confidence.",
    ...
    },
    {
      ...
      empathicMessage:
        "This information helps us ensure any prescribed medications are safe for you.",
      options: [
        "High blood pressure",
    ...
    },
    {
      ...
      subtitle:
        "Diabetes is a leading cause of ED affecting 50% of diabetic men",
      empathicMessage:
        "ED is often one of the first signs of diabetes. Good blood sugar control can improve symptoms.",
      options: [
        "No",
        "Yes, Type 1 diabetes",
    ...
    },
    {
      ...
      empathicMessage:
        "Don't worry about stopping any medications - we'll work around them or suggest alternatives.",
      options: [
    ...
    },
    {
      ...
      empathicMessage:
        "Small lifestyle changes combined with medication often provide the best results.",
      options: [
        "I smoke cigarettes",
    ...
    },
    {
      ...
      empathicMessage:
        "Morning erections are a good sign that your erectile mechanism is physically healthy.",
      options: [
    ...
    },
    {
      ...
      empathicMessage:
        "Treatment success often improves with partner support and understanding.",
      options: [
    ...
    },
    {
      ...
      empathicMessage:
        "If previous treatments didn't work, don't give up - we have multiple effective options.",
      options: [
        "Viagra (sildenafil)",
        "Cialis (tadalafil)",
        "Levitra (vardenafil)",
    ...
    },
    {
      ...
      subtitle:
        "Your preferences help us choose the best medication for your lifestyle",
      empathicMessage:
        "Different medications have different benefits - we'll find the one that matches your needs.",
      options: [
    ...
    },
    {
      ...
      empathicMessage:
        "Most side effects are mild and temporary. We'll choose medications that minimize your concerns.",
      options: [
        "Headaches",
        "Flushing or redness",
        "Stuffy nose",
  ...
  educationalInserts: [
    {
      ...
      content:
        "Erectile dysfunction affects more than 30 million men in the United States. By age 40, about 40% of men experience some degree of ED, and this increases to nearly 70% by age 70.",
      icon: "👥",
    ...
    },
    {
      ...
      content:
        "ED can be caused by physical factors (blood flow, nerve damage, hormones), psychological factors (stress, anxiety, depression), or a combination. Most cases are treatable regardless of the cause.",
      icon: "🧠",
    ...
    },
    {
      ...
      content:
        "ED is often an early warning sign of cardiovascular disease. The blood vessels in the penis are smaller than those around the heart, so they show problems first. Treating ED can actually improve overall heart health.",
      icon: "❤️",
    ...
    },
    {
      ...
      content:
        "Modern ED medications are highly effective: Viagra works for about 80% of men, Cialis for 85%, and newer medications have even higher success rates. Most men find a treatment that works for them.",
      icon: "📊",
  ...
  medications: [
    ...
    },
    {
      ...
      description:
        "Longest-lasting option. Works for up to 36 hours for spontaneity.",
    ...
    },
    {
      ...
      description:
        "Fast-acting with fewer food interactions than other options.",
  ...
  aiLogic: {
    ...
    contraIndicationRules: [
      {
        condition:
          'current_medications includes "Heart medications (especially nitrates)"',
        result: "medication_contraindicated",
        message:
          "ED medications cannot be safely combined with nitrate medications due to dangerous blood pressure drops. Please consult with your cardiologist.",
      },
      {
        condition:
          'cardiovascular_conditions includes "Heart disease or heart attack"',
        result: "consultation_required",
        message:
          "Recent cardiovascular events require cardiology clearance before starting ED medications for your safety.",
      },
    ],
  },
};
  ...
  const rocoFeatures = [
    {
      ...
      description:
        "Based on the International Index of Erectile Function used by urologists worldwide",
      icon: Stethoscope,
    ...
    },
    {
      ...
      description:
        "HIPAA-compliant platform with encrypted data and discrete packaging",
      icon: Lock,
      badge: "100% Private",
    },
    {
      ...
      description:
        "Every assessment reviewed by board-certified doctors specializing in men's health",
      icon: UserCheck,
    ...
    },
    {
      ...
      description:
        "Access to Viagra, Cialis, Levitra, Stendra and generic alternatives",
      icon: Pill,
      badge: "4 Medications",
    },
  ];
        ...
        <div className="text-center space-y-6">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto mb-4">
              Discrete, professional evaluation designed by healthcare experts.
              Following the same clinical standards used by urologists and men's
              health specialists.
            </p>
              ...
              <div className="space-y-6">
                {treatmentOutcomes.map((outcome, index) => (
                  <div key={index} className="space-y-2">
                    ...
                    <Progress value={parseInt(outcome.value)} className="h-2" />
                  </div>
                ))}
              </div>
              <div className="mt-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                <p className="text-sm text-green-800 dark:text-green-200">
                  <strong>Real Results:</strong> Data from over 500,000 men who
                  have completed this assessment and received treatment through
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {(medication as any).duration}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Onset:</span>
                      <span className="font-medium">
                        {(medication as any).onsetTime}
                      </span>
                    </div>
                    <div className="flex justify-between">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center py-4">
                <p className="text-gray-600 dark:text-gray-400 mb-3">
                  ... and {questionnaire.questions.length - 4} more
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-4">
                ...
                <p className="text-sm text-gray-600">
                  Your health information is encrypted and protected according
              ...
              <div className="text-center p-4">
                ...
                <p className="text-sm text-gray-600">
                  All communications and shipping are handled with complete
                  discretion
                </p>
              </div>
              <div className="text-center p-4">
