...
export function AdvancedAIPanel({ userId = "user-1" }: AdvancedAIPanelProps) {
  ...
  const [clinicalRecommendations, setClinicalRecommendations] =
    useState<any>(null);
  ...
  const loadAdvancedAnalytics = async () => {
    setLoading(true);
    try {
      const [cvRisk, interactions, analytics, score, clinical] =
        await Promise.all([
          ...
          fetch(`/api/ai/clinical-recommendations/${userId}`).then((r) =>
            r.json(),
          ),
        ]);
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Sophisticated medical AI analysis and predictions
            </p>
          </div>
        </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <Badge
                  className={getRiskColor(cardiovascularRisk.riskCategory)}
                >
              ...
              <div className="md:col-span-2">
                ...
                <div className="space-y-2">
                  {cardiovascularRisk.recommendations.map(
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                {drugInteractions.interactions.length > 0 ? (
                  <div className="space-y-3">
                    {drugInteractions.interactions.map(
              ...
              <div>
                ...
                {drugInteractions.pgxAlerts.length > 0 ? (
                  <div className="space-y-3">
                    {drugInteractions.pgxAlerts.map(
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    {drugInteractions.riskScore}/100
                  </div>
                </div>
                <Progress
                  value={drugInteractions.riskScore}
                  className="w-32 h-3"
                />
              </div>
            </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  {predictiveAnalytics.predictions.map(
              ...
              <div>
                ...
                <div className="space-y-3">
                  {predictiveAnalytics.riskFactors.map(
              ...
              <div>
                ...
                <div className="space-y-3">
                  {predictiveAnalytics.interventions.map(
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-3">
                <div className="glass-morphism p-3 rounded-lg">
                  ...
                  <div className="text-xl font-bold text-foreground">
                    {healthScore.categoryScores.cardiovascular}
                  </div>
                  <Progress
                    value={healthScore.categoryScores.cardiovascular}
                    className="h-2 mt-1"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="glass-morphism p-3 rounded-lg">
                  ...
                  <div className="text-xl font-bold text-foreground">
                    {healthScore.categoryScores.metabolic}
                  </div>
                  <Progress
                    value={healthScore.categoryScores.metabolic}
                    className="h-2 mt-1"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="glass-morphism p-3 rounded-lg">
                  ...
                  <div className="text-xl font-bold text-foreground">
                    {healthScore.categoryScores.lifestyle}
                  </div>
                  <Progress
                    value={healthScore.categoryScores.lifestyle}
                    className="h-2 mt-1"
                  />
                </div>
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div>
                ...
                <div className="space-y-3">
                  {clinicalRecommendations.recommendations.map(
              ...
              <div>
                ...
                <div className="space-y-3">
                  {clinicalRecommendations.alerts.map(
                    (alert: any, index: number) => (
                      <div
                        key={index}
                        className="glass-morphism p-4 rounded-xl"
              ...
              <div>
                ...
                <div className="space-y-3">
                  {clinicalRecommendations.followUp.map(
