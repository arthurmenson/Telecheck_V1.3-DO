...
export function ClinicalTools() {
    ...
    patient: [
      {
        ...
        description:
          "Personal diabetes monitoring with real-time glucose tracking, medication reminders, and care team communication",
        icon: Activity,
      ...
      },
      {
        ...
        description:
          "Photo-based wound tracking with healing progress monitoring and care instructions",
        icon: Bandage,
      ...
      },
      {
        ...
        description:
          "Submit daily vitals with automatic threshold checking and care team alerts",
        icon: Heart,
        category: "Monitoring",
      ...
      },
      {
        ...
        description:
          "Medication reminders, adherence tracking, and pharmacy communication",
        icon: Pill,
      ...
      },
      {
        ...
        description:
          "Schedule appointments, video visits, and care team consultations",
        icon: Calendar,
    ...
    provider: [
      {
        ...
        description:
          "Complete CCM workflow with patient registry, encounters, goals tracking, and CMS billing",
        icon: Clipboard,
      ...
      },
      {
        ...
        description:
          "Monitor all RPM patients with real-time alerts, device status, and billing integration",
        icon: Monitor,
      ...
      },
      {
        ...
        description:
          "Professional wound assessment, documentation, and treatment planning",
        icon: Eye,
        category: "Wound Care",
        badge: "Clinical",
        color: "text-purple-600 bg-purple-50",
      ...
      },
      {
        ...
        description:
          "Set and manage patient-specific alert thresholds and care protocols",
        icon: Target,
      ...
      },
      {
        ...
        description:
          "Automated lab interpretation with trend analysis and clinical recommendations",
        icon: TestTube,
        category: "Laboratory",
        badge: "Automated",
      ...
      },
      {
        ...
        description:
          "Medical calculators for dosing, risk assessment, and clinical decision support",
        icon: Calculator,
      ...
      },
      {
        ...
        description:
          "Comprehensive drug interaction analysis with severity ratings and recommendations",
        icon: AlertTriangle,
    ...
    admin: [
      {
        ...
        description:
          "Configure messaging services, alert thresholds, and care team communications",
        icon: MessageSquare,
      ...
      },
      {
        ...
        description:
          "Manage and configure RPM devices, connectivity, and data synchronization",
        icon: Smartphone,
      ...
      },
      {
        ...
        description:
          "Comprehensive billing integration with RPM, CCM codes and financial analytics",
        icon: CreditCard,
      ...
      },
      {
        ...
        description:
          "Monitor system performance, uptime, and service health across all modules",
        icon: BarChart3,
  ...
  const getFilteredCapabilities = () => {
    ...
    if (activeRole === "all") {
      capabilities = [
        ...clinicalCapabilities.patient,
        ...clinicalCapabilities.provider,
        ...clinicalCapabilities.admin,
      ];
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Comprehensive suite of RPM, CCM, wound management, and clinical
            tools organized by user role
          </p>
        </div>
          ...
          >
            <CardHeader>
              <div className="flex items-start justify-between">
                <div
                  className={`w-12 h-12 rounded-lg ${capability.color} flex items-center justify-center`}
                >
              ...
              <div className="space-y-3">
                ...
                <div className="pt-2">
                  ...
                  <Button
                    ...
                    onClick={() => (window.location.href = capability.route)}
                  >
                    Open Tool
                  </Button>
                </div>
