  ...
  const features = [
    {
      ...
      description:
        "Upload lab reports and get instant AI-powered analysis with color-coded ranges and personalized insights.",
      color: "bg-blue-500",
    },
    {
      icon: Pill,
      ...
      description:
        "Real-time drug interaction checking with PGx-aware alerts for safer medication management.",
      color: "bg-green-500",
    },
    {
      icon: Brain,
      ...
      description:
        "Get comprehensive health summaries with risk stratification and personalized recommendations.",
      color: "bg-purple-500",
    },
    {
      icon: ShoppingCart,
      ...
      description:
        "Seamless prescription fulfillment with discreet packaging and auto-refill options.",
      color: "bg-orange-500",
    },
    {
      icon: Dna,
      ...
      description:
        "Pharmacogenomic testing integration for personalized medication dosing and selection.",
      color: "bg-pink-500",
    },
    {
      icon: Heart,
      ...
      description:
        "Connect your devices for continuous health monitoring with DFPAS stasis scoring.",
      color: "bg-red-500",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "Telecheck has revolutionized how I interpret lab results. The AI insights save me hours and help me provide better patient care.",
      rating: 5,
    },
    {
      ...
      role: "Patient",
      content:
        "Finally, a platform that makes my health data understandable. The medication interaction alerts are a game-changer.",
      rating: 5,
    },
    {
      ...
      role: "Cardiologist",
      content:
        "The PGx integration and wearable data correlation provide insights I've never had access to before.",
      rating: 5,
    },
  ];
            ...
            <div className="lg:col-span-6">
              <div className="mb-8">
                ...
                <p className="mt-8 text-xl leading-relaxed text-muted-foreground max-w-2xl">
                  Revolutionary telehealth platform combining advanced AI with
                  personalized care. Get instant lab analysis, medication safety
                  checks, and expert medical insights—all in one secure
                  platform.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button
                  size="lg"
                  className="gradient-bg hover:shadow-2xl hover:shadow-primary/30 text-white border-0 px-10 py-5 text-lg font-semibold hover-lift group"
                  asChild
                >
                  <Link to="/register">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="glass-morphism hover:shadow-xl px-10 py-5 text-lg font-semibold hover-lift border-primary/30 group"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Leading the future of AI-powered healthcare with proven results
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <Card
                key={index}
                className="text-center border-0 shadow-sm hover:shadow-lg transition-all duration-300 hover-lift bg-background/50 backdrop-blur-sm"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="mt-6 text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Comprehensive AI-powered tools that work seamlessly together to
              provide you with the most accurate health insights and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="border-0 shadow-lg hover:shadow-2xl transition-all duration-500 hover-lift group bg-background/80 backdrop-blur-sm"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="mt-6 text-xl text-muted-foreground max-w-2xl mx-auto">
              See what doctors and patients are saying about their experience
              with Telecheck's AI-powered platform
            </p>
          </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white sm:text-5xl lg:text-6xl mb-8">
            Ready to transform{" "}
            <span className="text-white/90">your healthcare?</span>
          </h2>
          <p className="mt-6 text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            ...
            AI-powered insights to make better health decisions every day.
          </p>
          <div className="mt-12 flex flex-col sm:flex-row gap-6 justify-center">
            <Button
              size="lg"
              className="bg-white text-primary hover:bg-white/90 shadow-xl hover:shadow-2xl px-10 py-5 text-lg font-semibold hover-lift group"
              asChild
            >
              <Link to="/register">
                <Activity className="w-5 h-5 mr-3 group-hover:scale-110 transition-transform" />
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm px-10 py-5 text-lg font-semibold hover-lift group"
            >
