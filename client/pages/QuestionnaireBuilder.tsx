...
const QUESTIONNAIRE_TEMPLATES = [
  // Add GLP1 Questionnaire as featured template
  {
    ...
    description:
      "Comprehensive AI-powered questionnaire for GLP-1 medication evaluation with empathetic care",
  ...
  // Add Men's ED Ro.co-style template
  {
    ...
    description:
      "Professional, discrete erectile dysfunction evaluation following clinical standards used by specialists",
...
export function QuestionnaireBuilder() {
  ...
  React.useEffect(() => {
    import("../data/products").then((module) => {
      const medications = module.SAMPLE_PRODUCTS.filter(
        (product) => product.type === "prescription" || product.type === "otc",
      ).map((product) => ({
        id: product.id,
        name: product.name,
    ...
    setQuestions(
      questions.map((q) => {
        if (q.id === questionId) {
          ...
          const medicationExists = existingMeds.find(
  ...
  const removeMedicationFromQuestion = (
    questionId: string,
    medicationId: string,
  ) => {
    setQuestions(
  ...
  const progress =
    questions.length > 0
      ? calculateProgress(previewResponses, questions as any)
      : 0;
  ...
  return (
    <div className="min-h-screen aurora-bg">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Create compassionate patient assessments that prioritize comfort
              and understanding
            </p>
            {currentTemplate && (
          ...
          <div className="flex gap-3">
            <Button
              variant="outline"
              onClick={() => setShowEmpatheticMessages(!showEmpatheticMessages)}
            >
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {[
                        ...
                        const categoryQuestions = QUESTION_TYPES.filter(
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription>
                          {questions.length} questions • Est.{" "}
                          {currentTemplate?.estimatedTime || "5-8 min"}
                      ...
                      {questions.length === 0 ? (
                        <div className="text-center text-muted-foreground py-12">
                          ...
                          <h3 className="text-lg font-semibold mb-2">
                            Create Compassionate Care
                          </h3>
                          <p className="text-sm mb-4">
                            Start with an empathetic template or build your own
                                      ...
                                      <div className="flex items-center gap-2 mb-2">
                                        ...
                                        {(question as any).riskWeight && (
                                          <span className="text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded">
                                            Risk: {(question as any).riskWeight}
                                            /5
                                          </span>
                                        )}
                                      </div>
                                    ...
                                    >
                                      ...
                                      {(question.type ===
                                        ...
                                        <div className="space-y-3">
                                          ...
                                          question.medications.length > 0 ? (
                                            question.medications.map(
                                              (
                                                medication: any,
                                                medIndex: number,
                                              ) => (
                                    ...
                                    <div className="mt-3 p-2 bg-white dark:bg-gray-800 rounded border">
                                      ...
                                      <div className="text-xs">
                                        {(() => {
                                          ...
                                          const riskLevel =
                                            riskScore >
                                            currentTemplate.riskThreshold * 1.5
                                              ? "high"
                                              : riskScore >
                                                  currentTemplate.riskThreshold
                                                ? "medium"
                                                : "low";
                                          return (
                  ...
                  <CardContent>
                    {selectedQuestionData ? (
                      <div className="space-y-4">
                        ...
                        <div>
                          <Label htmlFor="question-subtitle">
                            Supportive Subtitle (Optional)
                          </Label>
                          <Input
                        ...
                        <div>
                          <Label htmlFor="question-supportive">
                            Empathetic Message (Optional)
                          </Label>
                          <Textarea
                            ...
                            onChange={(e) =>
                              updateQuestion(selectedQuestionData.id, {
                                supportiveMessage: e.target.value,
                              })
                            }
                        ...
                        {(selectedQuestionData.type === "multiple_choice" ||
                          ...
                          <div>
                            ...
                            <div className="space-y-2 mt-2">
                              {selectedQuestionData.options?.map(
                                (option, index) => (
                        ...
                        {(selectedQuestionData.type === "medication_selector" ||
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <Select
                                value={
                                  selectedQuestionData.medicationType || "any"
                                }
                                onValueChange={(value) =>
                                  updateQuestion(selectedQuestionData.id, {
                            ...
                            <div>
                              ...
                              <div className="space-y-2 max-h-40 overflow-y-auto">
                                {selectedQuestionData.medications?.length ? (
                                  selectedQuestionData.medications.map(
                      ...
                      <div className="text-center text-muted-foreground py-8">
                        ...
                        <p className="text-sm">
                          Select a question to configure its properties
                        </p>
                      </div>
                    )}
                  </CardContent>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">
                  Start with compassionate, clinically-validated assessments
                                    ...
                                    .map((question, index) => (
                                      ...
                                      >
                                        ...
                                        <div className="text-xs text-muted-foreground mb-2">
                                          {question.category} • Risk Weight:{" "}
                                          {question.riskWeight}/5
          ...
          <TabsContent value="assignments" className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Configure which questionnaires are automatically linked to
                specific products for personalized patient assessments
              </p>
              <Button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically show relevant questionnaires when customers
                    select specific products or medications
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Ensure patients receive the most appropriate assessment
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Reduce manual work by automatically triggering the right
          ...
          <TabsContent value="analytics" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Detailed breakdown of questionnaire performance
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm">
                    Response data and insights will appear here once you publish
                    your questionnaire
                  </p>
                </div>
              </CardContent>
      ...
      <Dialog
        open={showMedicationLibrary}
        onOpenChange={setShowMedicationLibrary}
      >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {availableMedications
                    .filter((med) => {
                      ...
                      if (
                        !questionData?.medicationType ||
                        questionData.medicationType === "any"
                      )
                        return true;
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="mt-2">
                                ...
                                <span className="text-xs text-foreground">
                                  {medication.dosages?.slice(0, 3).join(", ")}
                                </span>
                                {medication.dosages?.length > 3 && (
                                  <span className="text-xs text-muted-foreground">
                                    {" "}
                                    +{medication.dosages.length - 3} more
                                  </span>
                                )}
                              </div>
                            </div>
