            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {mockAnalytics.overview.activePatients.toLocaleString()}
                  </p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {mockAnalytics.overview.newThisMonth}
                  </p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {mockAnalytics.overview.riskPatients}
                  </p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold">
                    {mockAnalytics.overview.adherenceRate}%
                  </p>
                </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {mockAnalytics.conditions.mostCommon
                      .slice(0, 5)
                      .map((condition) => (
                        <div
                          key={condition.name}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            mockAnalytics.engagement.appointmentMetrics
                              .adherenceRate
                          }
                          %
                        </span>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            mockAnalytics.engagement.communicationStats
                              .responseRate
                          }
                          %
                        </span>
          ...
          <TabsContent value="demographics" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {mockAnalytics.demographics.genderDistribution.map(
                      (gender) => (
              ...
              <Card className="lg:col-span-2">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {mockAnalytics.demographics.conditionsByAge.map(
                      (condition) => (
                        <div
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {mockAnalytics.engagement.portalUsage.daily}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Weekly Active</span>
                      <span className="font-medium">
                        {mockAnalytics.engagement.portalUsage.weekly}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Monthly Active</span>
                      <span className="font-medium">
                        {mockAnalytics.engagement.portalUsage.monthly}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Never Used</span>
                      <span className="font-medium text-red-600">
                        {mockAnalytics.engagement.portalUsage.never}
                      </span>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {mockAnalytics.engagement.appointmentMetrics.scheduled}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Completed</span>
                      <span className="font-medium text-green-600">
                        {mockAnalytics.engagement.appointmentMetrics.completed}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">No Shows</span>
                      <span className="font-medium text-red-600">
                        {mockAnalytics.engagement.appointmentMetrics.noShows}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Cancelled</span>
                      <span className="font-medium text-yellow-600">
                        {mockAnalytics.engagement.appointmentMetrics.cancelled}
                      </span>
                    </div>
                    <hr />
                    <div className="flex justify-between">
          ...
          <TabsContent value="quality" className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {mockAnalytics.qualityMetrics.clinicalIndicators.map(
                      (indicator) => (
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {mockAnalytics.qualityMetrics.patientSafety.map(
                      (safety) => (
                        <div
                          key={safety.metric}
                          className="flex items-center justify-between p-3 border rounded-lg"
