            ...
            <CardContent className="space-y-6 sm:space-y-8 px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    {features.map((feature, index) => (
                      <div
                        key={index}
                        className="flex items-start space-x-3 p-3 sm:p-4 glass-morphism rounded-xl hover-lift border border-border/10"
                      >
              ...
              <div className="glass-morphism p-4 sm:p-6 lg:p-8 rounded-2xl border border-primary/20 bg-primary/5">
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
                  ...
                  <span className="font-semibold text-foreground text-base sm:text-lg text-center sm:text-left">
                    AI-Powered Development
                  </span>
                </div>
                <p className="text-muted-foreground text-center mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed px-2 sm:px-4">
                  This feature is currently being built with advanced AI
                  capabilities. Continue the conversation to help us prioritize
                  and develop this page.
                </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center pt-4 sm:pt-6">
                <Button
                  variant="outline"
                  asChild
                  className="glass-morphism hover:shadow-md hover-lift border-border/20 w-full sm:w-auto"
                >
                ...
                <Button
                  asChild
                  className="gradient-bg hover:shadow-lg hover:shadow-primary/25 text-white border-0 hover-lift w-full sm:w-auto"
                >
