  ...
  const validateStep = (step: number): boolean => {
    ...
    switch (step) {
      ...
      case 3:
        ...
        break;
      case 4:
        if (!registrationData.emergencyName.trim())
          newErrors.emergencyName = "Emergency contact name is required";
        if (!registrationData.emergencyPhone.trim())
          newErrors.emergencyPhone = "Emergency contact phone is required";
        if (!registrationData.emergencyRelation.trim())
          newErrors.emergencyRelation = "Relationship is required";
        break;
      case 8:
        if (!registrationData.hipaaConsent)
          newErrors.hipaaConsent = "HIPAA consent is required";
        if (!registrationData.termsAccepted)
          newErrors.termsAccepted = "Terms acceptance is required";
        break;
    }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateData("emergencyPhone", e.target.value)
                    }
                    placeholder="(555) 123-4567"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateData("emergencyRelation", e.target.value)
                  }
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Providing insurance information helps us verify coverage and
                reduce your costs.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateData("insuranceProvider", e.target.value)
                }
          ...
          <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {healthConcerns.map((concern) => (
                  <div key={concern} className="flex items-center space-x-2">
                    <Checkbox
                      id={concern}
                      checked={registrationData.primaryConcerns.includes(
                        concern,
                      )}
                      onCheckedChange={(checked) => {
                        if (checked) {
                          updateData("primaryConcerns", [
                            ...registrationData.primaryConcerns,
                            concern,
                          ]);
                        } else {
                          updateData(
                            "primaryConcerns",
                            registrationData.primaryConcerns.filter(
                              (c) => c !== concern,
                            ),
                          );
                        }
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  updateData("currentMedications", e.target.value)
                }
          ...
          <div className="space-y-4">
              ...
              <div className="space-y-2">
                {communicationOptions.map((option) => (
                  <div key={option} className="flex items-center space-x-2">
                    <Checkbox
                      id={option}
                      checked={registrationData.communicationPreferences.includes(
                        option,
                      )}
                      onCheckedChange={(checked) => {
                        if (checked) {
                          updateData("communicationPreferences", [
                            ...registrationData.communicationPreferences,
                            option,
                          ]);
                        } else {
                          updateData(
                            "communicationPreferences",
                            registrationData.communicationPreferences.filter(
                              (p) => p !== option,
                            ),
                          );
                        }
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) =>
                  updateData("languagePreference", e.target.value)
                }
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="marketingOptIn" className="text-sm">
                      I would like to receive health tips, news, and promotional
                      offers (optional)
                    </Label>
                  </div>
                </div>
        ...
        <Card className="mt-6 glass-morphism border border-green-200 bg-green-50/50 dark:bg-green-900/20">
          <CardContent className="p-4">
            ...
            <p className="text-xs text-green-700 dark:text-green-300 mt-1">
              All data is encrypted and HIPAA compliant. We never share your
